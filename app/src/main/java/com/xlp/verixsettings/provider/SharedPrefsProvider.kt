package com.xlp.verixsettings.provider
...
import com.xlp.verixsettings.utils.PrefsHelpers.getProtectedContext
...
class SharedPrefsProvider : ContentProvider() {
    ...
    override fun openAssetFile(uri: Uri, mode: String): AssetFileDescriptor? {
        ...
        if (uriMatcher.match(uri) == 5) {
            ...
            val context = getProtectedContext(context!!)
    ...
    companion object {
        const val AUTHORITY = "com.xlp.verixsettings.provider.sharedprefs"
